                    ...
                    <div class="card-body py-0 px-0 px-sm-3">
                        <div class="row align-items-center">
                            <div class="col-4 col-sm-3 col-xl-2">
                                <img src="{{ url('/') }}/admin/assets/images/dashboard/Group126@2x.png"
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="preview-list">
                            <div class="preview-item border-bottom">
                                <div class="preview-thumbnail">
                                    <img src="{{ url('/') }}/admin/assets/images/faces/face6.jpg" alt="image"
                            ...
                            <div class="preview-item border-bottom">
                                <div class="preview-thumbnail">
                                    <img src="{{ url('/') }}/admin/assets/images/faces/face8.jpg" alt="image"
                                        class="rounded-circle" />
                                </div>
                                <div class="preview-item-content d-flex flex-grow">
                                    <div class="flex-grow">
                            ...
                            <div class="preview-item border-bottom">
                                <div class="preview-thumbnail">
                                    <img src="{{ url('/') }}/admin/assets/images/faces/face9.jpg" alt="image"
                                        class="rounded-circle" />
                                </div>
                                <div class="preview-item-content d-flex flex-grow">
                                    <div class="flex-grow">
                            ...
                            <div class="preview-item border-bottom">
                                <div class="preview-thumbnail">
                                    <img src="{{ url('/') }}/admin/assets/images/faces/face11.jpg" alt="image"
                                        class="rounded-circle" />
                                </div>
                                <div class="preview-item-content d-flex flex-grow">
                                    <div class="flex-grow">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="owl-carousel owl-theme full-width owl-carousel-dash portfolio-carousel"
                            ...
                            <div class="item">
                                <img src="{{ url('/') }}/admin/assets/images/dashboard/Rectangle.jpg"
                                    alt="">
                            </div>
                            <div class="item">
                                <img src="{{ url('/') }}/admin/assets/images/dashboard/Img_5.jpg"
                                    alt="">
                            </div>
                            <div class="item">
                                <img src="{{ url('/') }}/admin/assets/images/dashboard/img_6.jpg"
                                    alt="">
                            </div>
                        </div>
                        <div class="d-flex py-4">
                            <div class="preview-list w-100">
                                <div class="preview-item p-0">
                                    <div class="preview-thumbnail">
                                        <img src="{{ url('/') }}/admin/assets/images/faces/face12.jpg"
