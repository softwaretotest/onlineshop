<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
        <a class="sidebar-brand brand-logo" href="index.html"><img src="{{ url('/') }}/admin/assets/images/logo.svg"
                alt="logo" /></a>
        <a class="sidebar-brand brand-logo-mini" href="index.html"><img
                src="{{ url('/') }}/admin/assets/images/logo-mini.svg" alt="logo" /></a>
    </div>
    <ul class="nav">
                ...
                <div class="profile-pic">
                    <div class="count-indicator">
                        <img class="img-xs rounded-circle "
                            src="{{ url('/') }}/admin/assets/images/faces/face15.jpg" alt="">
        ...
        <li class="nav-item menu-items">
            <a class="nav-link" href="{{ url('view_product_unit') }}">
                <span class="menu-icon">
                    <i class="mdi mdi-playlist-play"></i>
                </span>
